...
export const ch11_10_ex: Lesson = {
    id: 'ch11-10-ex',
    title: 'Bài tập 11.10: Testing Custom Types',
    duration: '20 phút',
    type: 'practice',
    isExercise: true,
    content: `
<p>Hãy thực hành test các custom types!</p>
<h3 class="task-heading">Yêu cầu</h3>
<ol class="task-list">
  <li>Tạo struct với methods</li>
  <li>Viết tests cho struct đó</li>
</ol>
`,
...
`,
    expectedOutput: 'Custom type tests passed!',
    testCases: [
        {
            input: 'rect1.area()',
            expectedOutput: '1500',
            description: 'Area = 30 * 50 = 1500'
        }
    ]
};
