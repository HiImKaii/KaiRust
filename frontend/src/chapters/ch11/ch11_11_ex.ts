...
export const ch11_11_ex: Lesson = {
    id: 'ch11-11-ex',
    title: 'Bài tập 11.11: Testing Enums',
    duration: '15 phút',
    type: 'practice',
    isExercise: true,
    content: `
<p>Hãy thực hành test Enums!</p>
<h3 class="task-heading">Yêu cầu</h3>
<ol class="task-list">
  <li>Tạo enum với nhiều variants</li>
  <li>Viết tests cho enum operations</li>
</ol>
`,
    defaultCode: `#[derive(Debug, PartialEq)]
enum Message {
    Quit,
    Move { x: i32, y: i32 },
    Write(String),
...
`,
    expectedOutput: 'Enum tests passed!',
    testCases: [
        {
            input: 'Message::Move { x: 10, y: 20 }.call()',
